		...
		switch (val) {
			case 0: { // l자 블럭
				...
				for (int a = 0; a < 2; a++) {
					Ui.frame.getGraphics().drawRect(x + a * r, y, r, r);
					Ui.frame.getGraphics().fillRect(x + a * r, y, r, r);
					Ui.frame.getGraphics().drawRect(x + r * (a + 1), y + r, r, r);
					Ui.frame.getGraphics().fillRect(x + r * (a + 1), y + r, r, r);
				}
				return;
			} case 6: { // ㄹ 반대 블럭
				for (int a = 0; a < 2; a++) {
					Ui.frame.getGraphics().drawRect(x + a * r, y + r, r, r);
					Ui.frame.getGraphics().fillRect(x + a * r, y + r, r, r);
					Ui.frame.getGraphics().drawRect(x + r * (a + 1), y, r, r);
					Ui.frame.getGraphics().fillRect(x + r * (a + 1), y, r, r);
				}
				return;
			}
		}
